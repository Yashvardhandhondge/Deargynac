...
const conditionColors: Record<string, string> = {
  ...
  discharge: 'bg-blue-100 text-blue-700', diagnostics: 'bg-amber-100 text-amber-800',
  fertility: 'bg-cyan-100 text-cyan-800', hormone: 'bg-violet-100 text-violet-800',
  ayurvedic: 'bg-emerald-100 text-emerald-800', mental: 'bg-fuchsia-100 text-fuchsia-800',
...
const borderColors: Record<string, string> = {
  active: '#D97894', pending: '#D97706', completed: '#16A34A', escalated: '#DC2626',
};
    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="bg-[#D97894] text-white rounded-full px-5 py-2 text-sm font-semibold hover:bg-[#C45F7E] transition-colors"
        >
          + New
        </button>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          {filter === 'All' && (
            <button
              onClick={() => router.push('/patient/book')}
              className="mt-4 text-[#D97894] font-semibold text-sm hover:text-[#C45F7E]"
            >
