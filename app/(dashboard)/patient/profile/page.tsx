  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-2xl p-8 border border-gray-100 text-center mb-6">
        <div className="w-20 h-20 rounded-full bg-[#C2185B] flex items-center justify-center text-white text-2xl font-bold mx-auto">
          {initial}
        </div>
        <h3 className="text-lg font-bold text-[#1A0A12] mt-4">{userName}</h3>
        <div className="flex items-center justify-center gap-2 mt-2">
          <span className="text-xs bg-rose-100 text-[#C2185B] px-3 py-1 rounded-full font-medium">Patient</span>
          {isAnonymous && (
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-100">
        <h3 className="font-semibold text-[#1A0A12] mb-4">Edit Profile</h3>
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="mt-6 bg-[#C2185B] text-white rounded-full px-6 py-2.5 text-sm font-semibold hover:bg-[#880E4F] transition-colors disabled:opacity-50 flex items-center gap-2"
        >
